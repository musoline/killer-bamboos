// ladders that intersect with platforms
...
class GameScene extends Phaser.Scene {
  ...
  preload() {
    this.load.setBaseURL('https://raw.githubusercontent.com/cedarcantab/photonstorm/main/issue-003/assets/')
    this.load.image('ground', 'ground.png'); // 400x32
    this.load.image('sky', 'sky.png');
    this.load.image('white', 'white.png')
    this.load.image('grassyground', 'grassyGround.png'); // 384x28
    this.load.image('ladder-thin-long', 'ladder-thin-long.png');
    this.load.image('ladder-thin-mid', 'ladder-thin-mid.png');
    this.load.image('ladder-thin-short', 'ladder-thin-short.png');
  ...
  create() {
    ...
    this.dude = new Dude(this, 100, 450);
  ...
  update(time, delta) {
    ...
    this.text.setText([
      'Dude:',
      '',
      "Top:" + this.dude.body.top,
      "Bottom" + this.dude.body.bottom,
      "Left: " + this.dude.body.left,
      "Right: " + this.dude.body.right,
      "Center.x: " + this.dude.body.center.x,
      JSON.stringify(Phaser.Utils.Objects.Pick(this.dude.body, ['blocked', 'touching', 'velocity', 'speed']), null, 2),
      "onFloor(): " + this.dude.body.onFloor(),
      "DeltaX(): " + this.dude.body.deltaX(),
      "DeltaY(): " + this.dude.body.deltaY(),
      "Status: " + this.dude.status
    ]);
